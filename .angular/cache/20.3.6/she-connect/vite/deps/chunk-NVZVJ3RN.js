...
var FirebaseAppImpl2 = class {
   ...
   * @internal
   */
  _getService(name5, instanceIdentifier = DEFAULT_ENTRY_NAME2) {
    var _a;
    this._delegate.checkDestroyed();
    const provider = this._delegate.container.getProvider(name5);
   ...
   * @internal
   */
  _removeServiceInstance(name5, instanceIdentifier = DEFAULT_ENTRY_NAME2) {
    this._delegate.container.getProvider(name5).clearInstance(instanceIdentifier);
  }
  /**
...
function createFirebaseNamespaceCore(firebaseAppImpl) {
  ...
  function removeApp(name5) {
    delete apps[name5];
  }
  function app(name5) {
    name5 = name5 || DEFAULT_ENTRY_NAME2;
    if (!contains(apps, name5)) {
  ...
  function useAsService(app2, name5) {
    if (name5 === "serverAuth") {
      return null;
    }
    const useService = name5;
    return useService;
  }
  return namespace;
}
  ...
  _get(key) {
    return __async(this, null, function* () {
      ...
      if (window.cookieStore) {
        const cookie = yield window.cookieStore.get(name5);
...
var CordovaPopupRedirectResolver = class {
  ...
  attachCallbackListeners(auth, manager) {
    ...
    const noEventTimeout = setTimeout(() => __async(null, null, function* () {
      yield _getAndRemoveEvent(auth);
      manager.onEvent(generateNoEvent());
    }), INITIAL_EVENT_TIMEOUT_MS);
    const universalLinksCb = (eventData) => __async(null, null, function* () {
    ...
    _cordovaWindow().handleOpenURL = (url) => __async(null, null, function* () {
...
var name4 = "@firebase/auth-compat";
var version4 = "0.5.28";
...
@firebase/auth/dist/esm2017/internal.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NVZVJ3RN.js.map
